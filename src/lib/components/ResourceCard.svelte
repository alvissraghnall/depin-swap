...
>
	...
	{#if statusMessage}
		<div
			class="rounded-lg border border-blue-500/20 bg-blue-500/10 px-3 py-2 text-sm text-blue-400"
		>
			{statusMessage}
		</div>
	{/if}
	...
	<div class="flex items-center justify-between border-t border-border p-4">
		...
		<div class="flex gap-2">
			<button
				...
				class="flex h-10 min-w-[40px] cursor-pointer items-center justify-center overflow-hidden rounded-lg bg-surface px-3 text-sm leading-normal font-bold tracking-[0.015em] text-text-primary transition-colors hover:bg-surface-hover disabled:cursor-not-allowed disabled:opacity-50"
			...
			<button
				...
				class="flex h-10 min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-lg bg-primary px-4 text-sm leading-normal font-bold tracking-[0.015em] text-primary-foreground transition-colors hover:bg-primary/90 disabled:cursor-not-allowed disabled:opacity-50"
			>
				<span class="truncate">
					{#if isProcessing}
						Processing...
