                                ...
                                <div class="flex flex-col gap-8 lg:col-span-2">
                                        ...
                                        <div class="flex flex-col gap-4 sm:flex-row">
                                                <button
                                                        ...
                                                        class="text-primary-foreground flex w-full items-center justify-center gap-2 rounded-lg bg-primary px-6 py-3 text-base font-bold shadow-lg shadow-primary/30 transition hover:bg-primary/90 disabled:cursor-not-allowed disabled:opacity-50"
                                                ...
                                                >
                                                        ...
                                                        <div class="mt-4 grid grid-cols-1 gap-x-4 gap-y-2 text-sm sm:grid-cols-2">
                                                                ...
                                                                <div class="flex justify-between py-2 sm:border-none">
                                                                        ...
                                                                        <span class="text-foreground">{listing.available ? 'Available' : 'Unavailable'}</span>
