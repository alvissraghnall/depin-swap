...
<main class="flex h-full grow flex-col">
    <div class="container mx-auto flex flex-1 justify-center px-4 py-10 sm:py-16">
        <div class="flex w-full max-w-2xl flex-col">
            ...
            <div
                class="flex w-full flex-col gap-6 rounded-xl border border-border bg-surface p-6 sm:p-8"
            >
                    ...
                    >
                        <div class="flex items-center justify-between gap-4">
                            ...
                            <button
                                ...
                                class="flex h-9 min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-lg bg-primary px-4 text-sm font-bold leading-normal tracking-[0.015em] text-primary-foreground transition-opacity hover:opacity-90"
                            >
                                Connect Wallet
                            </button>
                        </div>
                ...
                >
                    <div class="flex flex-col">
                        ...
                        <div class="relative">
                            <select
                                class="form-select w-full appearance-none rounded-lg border border-border bg-surface p-3.5 text-base leading-normal font-normal text-text-primary placeholder:text-text-secondary focus:border-primary focus:ring-1 focus:ring-primary disabled:opacity-50 disabled:cursor-not-allowed"
                                id="resource-type"
                                name="resourceType"
                            ...
                            >
                                ...
                                >
                                <option class="bg-background text-text-primary" value="storage"
                                    >Storage</option
                                >
                                <option class="bg-background text-text-primary" value="compute"
                                    >Compute</option
                                >
                                <option class="bg-background text-text-primary" value="bandwidth"
                                    >Bandwidth</option
                                >
                            </select>
                            <div
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <div class="flex flex-col">
                            ...
                            <div class="relative">
                                <input
                                    class="form-input w-full rounded-lg border border-border bg-surface p-3.5 pr-16 text-base leading-normal font-normal text-text-primary placeholder:text-text-secondary focus:border-primary focus:ring-1 focus:ring-primary disabled:opacity-50 disabled:cursor-not-allowed"
                                    id="amount"
                                    name="amount"
                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="relative">
                                <input
                                    class="form-input w-full rounded-lg border border-border bg-surface p-3.5 pr-20 text-base leading-normal font-normal text-text-primary placeholder:text-text-secondary focus:border-primary focus:ring-1 focus:ring-primary disabled:opacity-50 disabled:cursor-not-allowed"
                                    id="duration"
                                    name="duration"
                    ...
                    <div class="flex flex-col">
                        <div class="flex items-center gap-2 pb-2">
                            <label
                                class="text-base leading-normal font-medium text-text-primary"
                                for="price"
                                >Price</label
                            >
                    ...
                    <div class="flex flex-col">
                        ...
                        >
                        <input
                            class="form-input w-full rounded-lg border border-border bg-surface p-3.5 text-base leading-normal font-normal text-text-primary placeholder:text-text-secondary focus:border-primary focus:ring-1 focus:ring-primary disabled:opacity-50 disabled:cursor-not-allowed"
                            id="contact"
                            name="contact"
                    ...
                    <div class="pt-4">
                        ...
                        <p class="mt-4 text-center text-xs text-text-secondary">
                            Submitting the listing will require a wallet signature and a small gas
                            fee.
                        </p>
                    </div>
                </form>
