        ...
        {:else if !$isConnected}
            <div class="flex flex-col items-center justify-center py-16 gap-4">
                ...
                <button
                    ...
                    class="flex min-w-[120px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 bg-primary text-primary-foreground text-sm font-bold leading-normal tracking-[0.015em] transition-opacity hover:opacity-80"
                >
                    Connect Wallet
                </button>
            </div>
